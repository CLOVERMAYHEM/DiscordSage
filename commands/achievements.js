...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      .setTitle(`馃弳 ${targetUser.username}'s Achievements`)
    ...
    for (const [key, achievement] of Object.entries(ACHIEVEMENTS)) {
      if (userAchievements.unlocked.includes(key)) {
        ...
        lockedText += `馃敀 ${achievement.name}\n`;
    ...
    embed.addFields({
      name: "馃搳 Progress",
      value: `馃弳 ${unlockedCount}/${totalAchievements} achievements (${completionRate}%)\n猸� ${userAchievements.totalPoints} achievement points\n馃彺 Faction: ${userFaction}`,
      inline: false
    });
