...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (question) {
      embed.addFields({ name: "鉂� Decision", value: question, inline: false });
    }
    ...
    embed.addFields({ name: "鉁� Faction Fortune", value: flavorText, inline: false });
